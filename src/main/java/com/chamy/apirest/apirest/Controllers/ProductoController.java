package com.chamy.apirest.apirest.Controllers;
...
import com.chamy.apirest.apirest.Repositories.ProductoRepository;
...
public class ProductoController {
    ...
    @GetMapping("/{id}")
    public Producto obteProductoPorId(@PathVariable Long id){
